...
import com.example.target.materialhijricalendarview.format.ArrayWeekDayFormatter;
import com.example.target.materialhijricalendarview.format.DateFormatTitleFormatter;
import com.example.target.materialhijricalendarview.format.DayFormatter;
import com.example.target.materialhijricalendarview.format.MonthArrayTitleFormatter;
import com.example.target.materialhijricalendarview.format.TitleFormatter;
import com.example.target.materialhijricalendarview.format.WeekDayFormatter;
...
public class MaterialHijriCalendarView extends ViewGroup {
    ...
    public MaterialHijriCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        pager = new MonthPager(getContext());
     ...
     */
    public void setSelectedDate(@Nullable UmmalquraCalendar calendar) {
     ...
     */
    public void setDateSelected(@Nullable UmmalquraCalendar calendar, boolean selected) {
     ...
     */
    public void setCurrentDate(@Nullable UmmalquraCalendar calendar) {
     ...
     */
    public void setMinimumDate(@Nullable UmmalquraCalendar calendar) {
     ...
     */
    public void setMaximumDate(@Nullable UmmalquraCalendar calendar) {
     ...
     */
    public void setOnDateChangedListener(HijriFragment listener) {
     ...
     * @param listener thing to be notified
     */
    public void setOnMonthChangedListener(BasicActivity listener) {
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            l.onDateSelected(MaterialHijriCalendarView.this, day, selected);
        }
    }
    ...
    protected void dispatchOnMonthChanged(final CalendarDay day) {
        ...
        if (l != null) {
            l.onMonthChanged(MaterialHijriCalendarView.this, day);
        }
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (mDynamicHeightEnabled && adapter != null && pager != null) {
            UmmalquraCalendar cal = (UmmalquraCalendar) adapter.getItem(pager.getCurrentItem()).getCalendar().clone();
        ...
        for (int i = 0; i < count; i++) {
            ...
            int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(Integer.valueOf(MonthView.DEFAULT_DAYS_IN_WEEK * measureTileSize),
                    MeasureSpec.EXACTLY
            );
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(MaterialHijriCalendarView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MaterialHijriCalendarView.class.getName());
    }
