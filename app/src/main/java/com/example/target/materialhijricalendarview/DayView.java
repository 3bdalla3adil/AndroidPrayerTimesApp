...
import com.example.target.materialhijricalendarview.MaterialHijriCalendarView.ShowOtherDates;
import com.example.target.materialhijricalendarview.format.DayFormatter;

import java.util.List;

import static com.example.target.materialhijricalendarview.MaterialHijriCalendarView.showDecoratedDisabled;
import static com.example.target.materialhijricalendarview.MaterialHijriCalendarView.showOtherMonths;
import static com.example.target.materialhijricalendarview.MaterialHijriCalendarView.showOutOfRange;

/**
 * Display one day of a {@linkplain MaterialHijriCalendarView}
 */
...
class DayView extends CheckedTextView {
    ...
    @ShowOtherDates
    private int showOtherDates = MaterialHijriCalendarView.SHOW_DEFAULTS;
