...
import static com.example.target.materialhijricalendarview.MaterialHijriCalendarView.SHOW_DEFAULTS;
...
class MonthView extends ViewGroup implements View.OnClickListener {
    ...
    public MonthView(@NonNull MaterialHijriCalendarView view, CalendarDay month, int firstDayOfWeek, int calendarDiff) {
        ...
        UmmalquraCalendar calendar = resetAndGetWorkingCalendar();
